...
{
    BaseDeDatosTestFixture2 fixture =new BaseDeDatosTestFixture2();
    ...
    public void testDeserializarBDD()
    {
        ...
        Assert.assertEquals("Las base de datos deberian estar cargadas con 3 Colaboradores/Clientes/Servicios", this.fixture.bdd.getColaboradores().size(), 3);
        }
        catch(Exception e)
        {
